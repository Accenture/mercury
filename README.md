...
cd rest-example
mvn clean package
java -Dcloud.connector=none -jar target/rest-example-1.11.39.jar
...
cd event-node
mvn clean package
java -jar target/event-node-1.11.39.jar
...
cd lambda-example
mvn clean package
java -jar target/lambda-example-1.11.39.jar
...
java -jar target/rest-example-1.11.39.jar
...
mvn clean package
java -jar target/hazelcast-presence-1.11.39.jar
...
java -Dcloud.connector=hazelcast -jar target/lambda-example-1.11.39.jar
...
java -Dcloud.connector=hazelcast -jar target/rest-example-1.11.39.jar
