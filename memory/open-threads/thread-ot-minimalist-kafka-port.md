- [ ] (port — minimalist-kafka, 2026-09-14) **Bring the Kafka flow adapter + notification
  ...
  **Lock-step round** `feat/lockstep-4-12-13` `48506b99` (from main; Increment 128): the task↔skill gate,
  ...
  stacked on K5a — two commits; CI pending); **K5b = #304** (opened 2026-09-21, stacked on K5a — carries `0da85068` until #303 merges); the lock-step branch awaits its PR; Java release = mercury-composable #437. Increment 127 records the whole port.
