- [x] **Close stalled threads (due) — dispositioned 2026-09-17 (this repo's first closure gate, REVIEW.md step 8).**
  Eric closed all three: `bp-kafka-connectors-backlog` (93 — "the service-mesh using kafka is not in scope for
  Rust; minimal-kafka is in scope", which continues under `ot-minimalist-kafka-port`), `bp-foundation-to-ui`
