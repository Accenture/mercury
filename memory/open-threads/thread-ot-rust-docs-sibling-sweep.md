- [x] (docs) **Rust sibling sweep — SHIPPED with the claims-fixture gate** (PR #238, merge
  `76b8f282`, 2026-09-07). Outcome: 14 guide pages + llms.txt corrected, every item
  re-verified against THIS engine first; 20-claim registry + `check-doc-claims.py` wired
  into docs.yml AND rust.yml; 3 new pins + 3 pin upgrades; Increment 105; ADR-0018 (the
