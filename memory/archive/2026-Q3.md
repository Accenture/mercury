...
## 2026-09-07 — archived via archive-fact (faded (completed threads past archive_window: sslu 21 and 24 > 20))
...
<!-- id: ot-route-pool-twin | created: 2026-08-30 | last_used: 2026-09-02 | uses: 4 | tier: archive-candidate | origin: 2026-08-30-215256 -->

## 2026-09-10 — archived via archive-fact (faded — not referenced in over archive_window (20) sessions (sslu 27))

### Faded facts

*(playground-session-broker — REACTIVATED 2026-09-17: consulted 2026-09-14 for the broker-first hosting docs; moved back to continuity.md at the 2026-09-17 review)*

## 2026-09-10 — archived via archive-fact (completed thread past archive_window (sslu 31); all 4 never-decay facts + Vision confirmed 2026-09-02)
...
## 2026-09-10 — archived via archive-fact (faded — not referenced in over archive_window (20) sessions (sslu 21))
...
- **The memory layer and the Vision were installed BEFORE the first line of code (2026-07-15) —
  ...
  <!-- id: why-ai-enabled-before-code | created: 2026-09-04 | last_used: 2026-09-04 | uses: 2 | tier: archive-candidate | origin: 2026-09-04-043850 -->
...
- **This repo's `docs/llms.txt` is a CURATED agent map, not a full site map (Eric, 2026-09-04) —
  ...
  <!-- id: conv-llms-txt-curated-map | created: 2026-09-04 | last_used: 2026-09-04 | uses: 2 | tier: archive-candidate | origin: 2026-09-04-041456 -->

## 2026-09-17 — archived via archive-fact (faded — not referenced in over archive_window (20) sessions (review 2026-09-17; ADR-0018 keeps the claims-gate decision in the ledger))
...
- **Playground webapp lock-step sync: replace `crates/knowledge-graph/webapp/` wholesale
  ...
  **Engine help surface**: `crates/knowledge-graph/resources/help/help.md` prose is
  ...
  <!-- id: webapp-lockstep-sync-preserved-paths | created: 2026-09-08 | last_used: 2026-09-10 | uses: 7 | tier: archive-candidate | origin: 2026-09-08-203614.md -->

## 2026-09-17 — archived via archive-fact (swept: completed thread past archive_window (review 2026-09-17))
...
- [x] (lock-step) **tutorial-14's manager approval became a real three-outcome decision**
  (approve / reject / re-suspend wait loop), model byte-identical to Java. MERGED
  2026-08-07 as PR #193 (merge `bea95c80`), INCREMENTS 81. Durable engine facts: seen
  marks survive suspension — a wait loop must `RESET:` its own nodes before the IFs;
  Tutorials-tab help is baked at build time (`npm run release`). origin: 2026-08-07-150018
<!-- id: thread-tutorial-14-decision-rust | created: 2026-08-07 | last_used: 2026-08-07 | uses: 1 | tier: working | origin: 2026-08-07-150018 -->

- [x] (lock-step) **The v4.11.1 arc shipped** — version-aware Redis consume, per-task
  ttl + honored sub-flow delay, node ttl + model-metadata immutability, run-level
  watcher CAS arbitration, deadline propagation. Feature PR #191 (`5db06a8f`) + release
  PR #192 (`7358f1a2`), tag v4.11.1; Increments 76-80. Durable lesson: the Java-parity
  lens is the adversarial-review multiplier (14 confirmed findings). origin: 2026-08-01-233448
<!-- id: thread-v4-11-1-lockstep | created: 2026-08-01 | last_used: 2026-08-01 | uses: 1 | tier: working | origin: 2026-08-01-233448 -->

## 2026-09-24 — archived via archive-fact (completed thread past archive_window - swept at the 2026-09-24 seam close)
...
## 2026-09-25 — archived via archive-fact (faded past archive_window 20 at the release/4.12.19 seam; the rule stands in the workspace manifests and the archive keeps it retrievable)
