...
- **last_session:** 2026-07-18 | agent: Claude Code (2026-07-18-183953)
...
- **Port bottom-up, faithfully to the Java original** — re-implement mercury-composable in
  ...
  <!-- id: port-bottom-up-faithful | created: 2026-07-15 | last_used: 2026-07-18 | uses: 17 | tier: active | origin: 2026-07-15-215538.md -->
## Conventions
...
- [ ] **(blueprint)** **Synchronous AI-companion feedback** — make the companion a real AI *tool*, not
  ...
  **Live multi-party demo DONE (2026-07-18, session ws-240155-2):** a fresh companion built+ran tut-4
  ...
  tests reference the Rust repo. **Java upstream: design ADR-0008 MERGED**
  ([#188](https://github.com/Accenture/mercury-composable/pull/188)) **+ implementation PR OPEN**
  ([#189](https://github.com/Accenture/mercury-composable/pull/189)) — `PostCompanionCommandSync`
  (mirrors the Rust mechanism: RPC + private capture route + FIFO sentinel + WS tee) with
  `CompanionSyncTest`; full minigraph module suite green (64 tests); ADR-0008 → Accepted. **This
  blueprint gap is DELIVERED in Rust and PR-complete in Java** — only the merge of #189 remains
  (owned upstream). → serves: vision-mercury
  <!-- id: bp-companion-sync | created: 2026-07-18 | last_used: 2026-07-18 | uses: 6 | tier: working | origin: 2026-07-18-162832.md -->
