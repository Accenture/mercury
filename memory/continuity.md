...
- **last_session:** 2026-07-19 | agent: Claude Code (2026-07-19-155715)
...
- **Port bottom-up, faithfully to the Java original** — re-implement mercury-composable in
  ...
  <!-- id: port-bottom-up-faithful | created: 2026-07-15 | last_used: 2026-07-19 | uses: 29 | tier: active | origin: 2026-07-15-215538.md -->
## Conventions
...
- [ ] **AI-companion validation sweep (tutorials 1–13)** — dogfooding the full human–AI
  ...
  log: `docs/AI-companion-test.md`. **Done: 1, 2, 3, 4, 5, 6, 7.** Tut-3 surfaced + drove the
  ...
  *purpose*, hardening the Rust port toward production quality. **Tut-5 (L4, composition:
  ...
  seeds unshown) FIXED same day. **Resume — NEXT: tutorial-8.** Same recipe: fresh primary
  (**verify EMPTY first**), brief = llms.txt + its map, drive via `/sync`, watcher subscribes over
  the WS connection; tutorial help pages carry known errors (backlog [[ot-help-pages-rewrite]]) —
  derive contracts carefully.
  **Layer-1/2 AI docs ported for tutorials 6+ (2026-07-19, maintainer-directed):**
  ...
  <!-- id: ot-companion-validation-sweep | created: 2026-07-18 | last_used: 2026-07-19 | uses: 12 | tier: working | origin: 2026-07-18-061457.md -->
...
- [ ] **(backlog) Rewrite the interactive help pages for human operators.** Maintainer decision
  ...
  <!-- id: ot-help-pages-rewrite | created: 2026-07-18 | last_used: 2026-07-19 | uses: 3 | tier: working | origin: 2026-07-18-231641.md -->
...
- [ ] **(blueprint)** **Synchronous AI-companion feedback** — make the companion a real AI *tool*, not
  ...
  **The companion `/sync` feature is COMPLETE and MERGED in both ports** (Rust R&D main + Java upstream
  ...
  → serves: vision-mercury
  <!-- id: bp-companion-sync | created: 2026-07-18 | last_used: 2026-07-19 | uses: 14 | tier: working | origin: 2026-07-18-162832.md -->
