...
- **last_session:** 2026-07-17 | agent: Claude Code (2026-07-17-010622)
...
- [ ] **Design + port the knowledge graph (layer 3)** — the working thread realizing
  ...
  **graph.js deferred** (GraalVM → no free Rust analog; boa_engine if wanted); TWO platform-core
  ...
  **GATE PENDING**: 4 open questions (crate name, graph.js, tokio-tungstenite, examples app).
  → serves: vision-mercury
