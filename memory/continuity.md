...
- **last_session:** 2026-07-18 | agent: Claude Code (2026-07-18-171244)
...
- **Example apps are standalone `examples/<name>/` workspace crates** (increment 10,
  ...
  <!-- id: conventions-rust-baseline | created: 2026-07-15 | last_used: 2026-07-18 | uses: 36 | tier: active | origin: 2026-07-15-224707.md -->
...
- [x] **(blueprint)** Port **platform-core** to Rust — the foundation layer; everything else
  ...
  <!-- id: bp-platform-core | created: 2026-07-15 | last_used: 2026-07-18 | uses: 27 | tier: active | origin: 2026-07-15-215538.md -->
...
- [ ] **(blueprint)** **Synchronous AI-companion feedback** — make the companion a real AI *tool*, not
  ...
  aborted). Design: an **additive** `POST /api/companion/{id}/command` returning a structured envelope
  ...
  WS console or a GET fallback; errors + run results both return in-band. **Remaining:** (a) PR the
  design to the Java upstream (gap exists there too); (b) doc the sync endpoint in the ai-agent-guide;
  (c) optional: tee output to WS too so a watching human still sees live console (v1 captures to the
  caller only). → serves: vision-mercury
  <!-- id: bp-companion-sync | created: 2026-07-18 | last_used: 2026-07-18 | uses: 2 | tier: working | origin: 2026-07-18-162832.md -->
