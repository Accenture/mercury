...
- [ ] **Design + port event-script (layer 2)** — the working thread realizing
  ...
  **Next: E-2 — data-mapping engine** (runtime LHS/RHS resolution over serde_json::Value,
  serde_json_path for `$.…`). → serves: vision-mercury
