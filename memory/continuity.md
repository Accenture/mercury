...
- **last_session:** 2026-07-17 | agent: Claude Code (2026-07-17-033312)
...
- [ ] **Design + port the knowledge graph (layer 3)** — the working thread realizing
  ...
  **graph.js retirement enforced in code** (explicit message → graph.math/graph.task);
  ...
  HTTP first run; §7 http-client deferral CLOSED; workspace 177 green. Next: K-6
  graph.extension + remaining REST endpoints (activates hello* graphs, tutorials 10/11).
  → serves: vision-mercury
