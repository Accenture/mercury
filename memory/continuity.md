...
- **last_session:** 2026-07-18 | agent: Claude Code (2026-07-18-170029)
...
- [ ] **(blueprint)** **Synchronous AI-companion feedback** — make the companion a real AI *tool*, not
  ...
  (`Platform::register`). Design note: `docs/design/ai-companion-sync.md`. **Plan:** prototype in Rust
  (this repo), re-verify by re-running the Tut-4 companion (it should self-correct from the returned
  error), then PR the design to the Java upstream (the gap exists there too). → serves: vision-mercury
  <!-- id: bp-companion-sync | created: 2026-07-18 | last_used: 2026-07-18 | uses: 1 | tier: working | origin: 2026-07-18-162832.md -->
