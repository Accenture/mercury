...
- **last_session:** 2026-07-17 | agent: Claude Code (2026-07-17-235350)
...
- [ ] **Design + port the knowledge graph (layer 3)** — the working thread realizing
  ...
  **graph.js retirement enforced in code** (explicit message → graph.math/graph.task);
  ...
  live-graph download). Workspace **181 green**, clippy 0, fmt clean. Next: **K-8 — the React
  webapp + layer-3 milestone close**.
  → serves: vision-mercury
