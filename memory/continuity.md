...
- **Example apps are standalone `examples/<name>/` workspace crates** (increment 10,
  ...
  <!-- id: conventions-rust-baseline | created: 2026-07-15 | last_used: 2026-07-16 | uses: 19 | tier: active | origin: 2026-07-15-224707.md -->
...
- [ ] **(blueprint)** Port **event-script** to Rust (on top of platform-core).
  **Design drafted 2026-07-16** (`docs/design/event-script-port.md` v1) — gate pending.
  ...
  <!-- id: bp-event-script | created: 2026-07-15 | last_used: 2026-07-16 | uses: 12 | tier: working | origin: 2026-07-15-215538.md -->
...
- [ ] **Design + port event-script (layer 2)** — the working thread realizing
  ...
  **Next: E-8 — simple plugins** (remaining ~23 bodies: arithmetic/generators/date/list-of-map/
  validate/ternary/comparisons + the `#[simple_plugin]` registration macro); then E-9 (HTTP
  adapter + Resilience4Flow + EventScriptMock + examples/hello-flow, milestone close).
  → serves: vision-mercury
  <!-- id: ot-design-event-script | created: 2026-07-16 | last_used: 2026-07-16 | uses: 9 | tier: working | origin: 2026-07-16-174644.md -->
