...
- **last_session:** 2026-07-18 | agent: Claude Code (2026-07-18-180137)
...
- [ ] **(blueprint)** **Synchronous AI-companion feedback** — make the companion a real AI *tool*, not
  ...
  **Live multi-party demo DONE (2026-07-18, session ws-240155-2):** a fresh companion built+ran tut-4
  ...
  now live here (reflect Rust: `graph.js` retired, sync `/command` documented, graph.math dialect
  narrowness); future companion tests reference the Rust repo. **Remaining:** (a) PR the design +
  synchronous endpoint to the Java upstream (the gap exists there too). → serves: vision-mercury
  <!-- id: bp-companion-sync | created: 2026-07-18 | last_used: 2026-07-18 | uses: 4 | tier: working | origin: 2026-07-18-162832.md -->
