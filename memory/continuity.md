...
- **Port bottom-up, faithfully to the Java original** — re-implement mercury-composable in
  ...
  <!-- id: port-bottom-up-faithful | created: 2026-07-15 | last_used: 2026-07-18 | uses: 10 | tier: active | origin: 2026-07-15-215538.md -->
...
- **Example apps are standalone `examples/<name>/` workspace crates** (increment 10,
  ...
  <!-- id: conventions-rust-baseline | created: 2026-07-15 | last_used: 2026-07-18 | uses: 31 | tier: active | origin: 2026-07-15-224707.md -->
...
- [x] **(blueprint)** Port **platform-core** to Rust — the foundation layer; everything else
  ...
  <!-- id: bp-platform-core | created: 2026-07-15 | last_used: 2026-07-18 | uses: 24 | tier: active | origin: 2026-07-15-215538.md -->
- [x] **(blueprint)** Port **event-script** to Rust (on top of platform-core).
  **MILESTONE CLOSED 2026-07-17** (increments E-1…E-9 / repo 11–20; design
  ...
  <!-- id: bp-event-script | created: 2026-07-15 | last_used: 2026-07-17 | uses: 17 | tier: active | origin: 2026-07-15-215538.md -->
- [x] **(blueprint)** Port the **active knowledge graph** to Rust.
  **MILESTONE CLOSED 2026-07-18** (increments K-1…K-8 / repo 21–29; design
  ...
  <!-- id: bp-active-knowledge-graph | created: 2026-07-15 | last_used: 2026-07-18 | uses: 13 | tier: active | origin: 2026-07-15-215538.md -->
...
- [x] **Design + port the knowledge graph (layer 3)** — the working thread realizing
  ...
  **graph.js retirement enforced in code** (explicit message → graph.math/graph.task);
  ...
  vision-mercury
  <!-- id: ot-design-knowledge-graph | created: 2026-07-17 | last_used: 2026-07-18 | uses: 10 | tier: active | origin: 2026-07-17-010622.md -->
