...
Also: shipped as PR [#157](https://github.com/Accenture/mercury/pull/157), MERGED 2026-07-21
(true merge `70a61879`, CI green). NEXT UP when work resumes: remediation item 5 — the
fetcher cache key (dictionary-declared inputs only; the last High).
