...
Also: shipped as PR [#151](https://github.com/Accenture/mercury/pull/151), MERGED 2026-07-21
(true merge `55521b80`; docs deploy ran on merge — gh-pages verified serving the literal
`HH:mm:ss`, live URL pending only CDN cache expiry).
