...
/**
 * This demonstrates regular fork-n-join. Note that the po.request() method is a blocking call.
 */
@Path("/rpc")
public class RpcHelloConcurrent {
    ...
    public Map<String, Object> hello(@Context HttpServletRequest request) throws IOException, AppException {
        ...
        /*
         * Note that for parallel requests, you may receive partial results if some target
         * com.accenture.examples.services did not respond.
