...
1. Open sources library update (Vertx 4.5.3 and MsgPack 0.9.8)
---
...
Print out basic JVM info before app starts.
...
Backport LocalPubSub and Benchmark tool from Mercury 3.0.5
