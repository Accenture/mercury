...
java -jar target/benchmark-client-3.0.7.jar
```
...
java -jar target/benchmark-server-3.0.7.jar
cd sandbox/mercury/connectors/adapter/kafka/kafka-presence
java -jar target/kafka-presence-3.0.7.jar
cd sandbox/mercury/benchmark-client
java -Dcloud.connector=kafka -jar target/benchmark-client-3.0.7.jar
```
