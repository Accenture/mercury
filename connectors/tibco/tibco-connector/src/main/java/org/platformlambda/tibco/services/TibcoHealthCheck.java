...
public class TibcoHealthCheck implements LambdaFunction {

    private static final String MANAGER = TibcoSetup.MANAGER;
    ...
    public Object handleEvent(Map<String, String> headers, Object body, int instance) throws Exception {
        ...
        if (INFO.equals(headers.get(TYPE))) {
            ...
            result.put("service", "tibco");
            result.put("href", TibcoSetup.getDisplayUrl());
            return result;
        }
        ...
        if (HEALTH.equals(headers.get(TYPE))) {
            if (presenceMonitor) {
                ...
                if (response.getBody() instanceof List) {
                    ...
                    if (list.isEmpty()) {
                        return "Tibco is healthy but it does not have any topics";
                    } else {
                        return "Tibco is healthy and it contains " +
