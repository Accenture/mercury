...
public class ActiveMqHealthCheck implements LambdaFunction {
    ...
    public Object handleEvent(Map<String, String> headers, Object body, int instance) throws Exception {
        ...
        if (INFO.equals(headers.get(TYPE))) {
            ...
            result.put("service", "activemq");
            result.put("href", ActiveMqSetup.getDisplayUrl());
            return result;
        }
        ...
        if (HEALTH.equals(headers.get(TYPE))) {
            if (presenceMonitor) {
                ...
                if (response.getBody() instanceof List) {
                    ...
                    if (list.isEmpty()) {
                        return "ActiveMQ is healthy but it does not have any topics";
                    } else {
                        return "ActiveMQ is healthy and it contains " +
