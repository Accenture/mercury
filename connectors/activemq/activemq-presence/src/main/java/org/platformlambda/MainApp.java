...
import org.platformlambda.activemq.PresenceHandler;
...
public class MainApp implements EntryPoint {
    ...
    public static final String CLOUD_MANAGER = ActiveMqSetup.CLOUD_MANAGER;
    ...
    private void setup() throws TimeoutException, IOException {
        ...
        String firstPartition = monitorTopic + ".0";
