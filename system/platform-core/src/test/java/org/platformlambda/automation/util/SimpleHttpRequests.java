...
public class SimpleHttpRequests {
    ...
    public static String get(String url) throws IOException, AppException {
        return get(url, APPLICATION_JSON);
    }

    public static String get(String url, String accept) throws IOException, AppException {
        return get(url, accept, new HashMap<>());
    }

    public static String get(String url, Map<String, String> reqHeaders) throws IOException, AppException {
        return get(url, APPLICATION_JSON, reqHeaders);
    }

    public static String get(String url, String accept, Map<String, String> reqHeaders)
    ...
    public static String post(String url, Map<String, String> reqHeaders, Map<String, Object> data)
            throws IOException, AppException {
