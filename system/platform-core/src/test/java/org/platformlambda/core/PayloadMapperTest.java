...
public class PayloadMapperTest {
    ...
    public void optionalTransport() throws IOException {
        ...
        event2.load(b);
        Assertions.assertTrue(event2.getBody() instanceof Optional);
        Optional<Object> value = (Optional<Object>) event2.getBody();
        Assertions.assertTrue(value.isPresent());
        Assertions.assertEquals(text, value.get());
    }
    ...
    public void pojoTransport() throws IOException {
        ...
        EventEnvelope event2 = new EventEnvelope();
        event2.load(b);
        Assertions.assertEquals(PoJo.class, event2.getBody().getClass());
    }
    ...
    public void rejectUnauthorizedClass() throws IOException {
         ...
         */
        Assertions.assertEquals(HashMap.class, event2.getBody().getClass());
    }
    ...
    public void pojoInEvent() throws IOException {
        ...
        Assertions.assertTrue(len2 > len1);
    }
    ...
    private int pojoInEventUsingMsgPack() throws IOException {
        ...
        EventEnvelope event2 = new EventEnvelope();
        event2.load(b);
        Assertions.assertEquals(input.getClass(), event2.getBody().getClass());
        Assertions.assertTrue(event2.isBinary());

        PoJo o = (PoJo) event2.getBody();
        Assertions.assertEquals(input.getName(), o.getName());
        Assertions.assertEquals(input.getNumber(), o.getNumber());
        return b.length;
    }
    ...
    private int pojoInEventUsingGson() throws IOException {
        ...
        event2.load(b);
        Assertions.assertEquals(input.getClass(), event2.getBody().getClass());
        Assertions.assertFalse(event2.isBinary());
    ...
    public void convertPoJoUsingMsgPack() throws ClassNotFoundException {
        ...
        Assertions.assertEquals(input.getClass().getName(), typed.getType());
        Assertions.assertTrue(typed.getPayload() instanceof Map);
        Object converted = converter.decode(typed);
        Assertions.assertTrue(converted instanceof PoJo);
    ...
    public void convertPoJoUsingJson() throws ClassNotFoundException {
        ...
        Assertions.assertEquals(input.getClass().getName(), typed.getType());
        Assertions.assertTrue(typed.getPayload() instanceof byte[]);
        Object converted = converter.decode(typed);
        Assertions.assertTrue(converted instanceof PoJo);
        PoJo o = (PoJo) converted;
        Assertions.assertEquals(input.getName(), o.getName());
    ...
    public void datePayloadTest() throws IOException {
        ...
        Assertions.assertEquals(util.date2str(now), o);
        byte[] b = event.toBytes();
        EventEnvelope restored = new EventEnvelope(b);
        Assertions.assertEquals(util.date2str(now), restored.getBody());
    }
    ...
    public void convertMap() throws ClassNotFoundException {
        ...
        TypedPayload typed = converter.encode(input, true);
        Assertions.assertEquals(PayloadMapper.MAP, typed.getType());
        Assertions.assertEquals(input, typed.getPayload());
        Object converted = converter.decode(typed);
        Assertions.assertEquals(input, converted);
    }
    ...
    public void convertString() throws ClassNotFoundException {
        ...
        TypedPayload typed = converter.encode(input, true);
        Assertions.assertEquals(PayloadMapper.PRIMITIVE, typed.getType());
        Assertions.assertEquals(input, typed.getPayload());
        Object converted = converter.decode(typed);
        Assertions.assertEquals(input, converted);
    }
    ...
    public void convertNull() throws ClassNotFoundException {
        ...
        Assertions.assertEquals(PayloadMapper.NOTHING, typed.getType());
        Assertions.assertNull(typed.getPayload());
        Object converted = converter.decode(typed);
    ...
    public void convertBoolean() throws ClassNotFoundException {
        ...
        Assertions.assertEquals(PayloadMapper.PRIMITIVE, typed.getType());
        Assertions.assertEquals(true, typed.getPayload());
        Object converted = converter.decode(typed);
    ...
    public void convertDate() throws ClassNotFoundException {
        ...
        TypedPayload typed = converter.encode(input, true);
        Assertions.assertEquals(PayloadMapper.PRIMITIVE, typed.getType());
        Assertions.assertEquals(util.date2str(input), typed.getPayload());
        Object converted = converter.decode(typed);
        Assertions.assertEquals(util.date2str(input), converted);
    }
    ...
    public void convertList() throws ClassNotFoundException {
        ...
        input.add("world");
        TypedPayload typed = converter.encode(input, true);
        Assertions.assertEquals(PayloadMapper.LIST, typed.getType());
        Assertions.assertEquals(input, typed.getPayload());
        Object converted = converter.decode(typed);
        Assertions.assertEquals(input, converted);
    }
    ...
    public void convertArray() throws ClassNotFoundException {
        ...
        Assertions.assertEquals(PayloadMapper.LIST, typed.getType());
        Object converted = converter.decode(typed);
        Assertions.assertEquals(Arrays.asList(input), converted);
    }
