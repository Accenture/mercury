 ...
 * i.e. when user defined websocket server using WebSocketService.class is found.
 */
public class ActuatorServiceHandler implements Handler<HttpServerRequest> {

    private static final Logger log = LoggerFactory.getLogger(ActuatorServiceHandler.class);
